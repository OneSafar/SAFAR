...
export default function Streaks() {
  ...
  const generateCalendar = () => {
    ...
    for (let i = 55; i >= 0; i--) {
      ...
      const level = Math.random() > 0.7 ? 2 : Math.random() > 0.4 ? 1 : 0;
            ...
            <div className="md:col-span-2 rounded-[1.5rem] glass-high p-6 md:p-8 shadow-sm hover:-translate-y-1 transition-transform duration-200">
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mt-1">Your engagement over the last 8 weeks</p>
                </div>
                  ...
                  <div className="grid grid-cols-7 gap-2">
                    {calendarDays.map((day, idx) => (
                      <div
                        ...
                        className={`aspect-square rounded-md flex items-center justify-center text-xs font-medium ${day.level > 0
